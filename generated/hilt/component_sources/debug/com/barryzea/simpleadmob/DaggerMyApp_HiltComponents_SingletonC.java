...
import com.barryzea.simpleadmob.di.AppModule_DataBaseProviderFactory;
import com.barryzea.simpleadmob.model.RepositoryImpl;
import com.barryzea.simpleadmob.view.HistoryFragment;
import com.barryzea.simpleadmob.view.MainActivity;
import com.barryzea.simpleadmob.view.dialogs.ConverterMeasureDialog;
import com.barryzea.simpleadmob.view.measureListFragment;
import com.barryzea.simpleadmob.viewModel.HistoryViewModel;
import com.barryzea.simpleadmob.viewModel.HistoryViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends MyApp_HiltComponents.FragmentC {
    ...
    @Override
    public void injectConverterMeasureDialog(ConverterMeasureDialog converterMeasureDialog) {
    }

    @Override
    public void injectmeasureListFragment(measureListFragment measureListFragment) {
    }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    private RepositoryImpl repositoryImpl() {
      return new RepositoryImpl(singletonCImpl.dataBaseProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.barryzea.simpleadmob.viewModel.HistoryViewModel", ((Provider) historyViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.barryzea.simpleadmob.viewModel.HistoryViewModel 
          return (T) new HistoryViewModel(viewModelCImpl.repositoryImpl());
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private Provider<HistoryDAO> dataBaseProvider;
    ...
    private void initialize(final AppModule appModuleParam,
      ...
      this.dataBaseProvider = DoubleCheck.provider(new SwitchingProvider<HistoryDAO>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.barryzea.simpleadmob.common.database.HistoryDAO 
          return (T) AppModule_DataBaseProviderFactory.dataBaseProvider(singletonCImpl.appModule, ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));
