 ...
 */
abstract class Hilt_measureListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_measureListFragment() {
    super();
  }

  Hilt_measureListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((measureListFragment_GeneratedInjector) this.generatedComponent()).injectmeasureListFragment(UnsafeCasts.<measureListFragment>unsafeCast(this));
    }
  }
