 ...
 */
abstract class Hilt_ConverterMeasureDialog extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConverterMeasureDialog() {
    super();
  }

  Hilt_ConverterMeasureDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConverterMeasureDialog_GeneratedInjector) this.generatedComponent()).injectConverterMeasureDialog(UnsafeCasts.<ConverterMeasureDialog>unsafeCast(this));
    }
  }
